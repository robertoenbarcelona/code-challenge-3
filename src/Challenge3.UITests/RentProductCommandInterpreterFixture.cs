...
namespace Challenge3.UITests
{
    ...
    [TestClass]
    public class RentProductCommandInterpreterFixture
    {
        [TestMethod]
        public void RentProductCommandInterpreter_HandleRent()
        {
            //Arrange
            ...
            A.CallTo(() => rentService.RentProduct(A<string>.Ignored, A<string>.Ignored)).Returns(new OperationMessage() { Succeed = true, Message = expectedMessage });
